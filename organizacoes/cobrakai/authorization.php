...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('cobrakaisonoda' => new PermissionSet(false, false, false, false))
    ,
    'adminkcb' => 
        array('cobrakaisonoda' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'cobrakai' => new PermissionSet(true, true, true, true));

$dataSourceRecordPermissions = array();

$tableCaptions = array('cobrakaisonoda' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
