...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Cobrakai - Carapicuíba', 'filename' => 'cobrakai.php', 'name' => 'cobrakaisonoda', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Cobrakai - Carapicuíba - SP<br>
Coordenação técnica: Shihan Luciano Fernandes<br>
Faixa Preta 4º DAN';
}
