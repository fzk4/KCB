 ...
 */
    ...
    class toeikanembuPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Toeikan - Embú das Artes');
    ...
    try
    {
        $Page = new toeikanembuPage("toeikanembu", "toeikanembu.php", GetCurrentUserPermissionsForPage("toeikanembu"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("toeikanembu"));
