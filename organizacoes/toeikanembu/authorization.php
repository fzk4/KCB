...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('toeikanembu' => new PermissionSet(false, false, false, false))
    ,
    'toeikanembu' => 
        array('toeikanembu' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'toeikanembu' => new PermissionSet(true, true, true, true),
...
$tableCaptions = array('toeikanembu' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
