...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Toeikan - Embú das Artes', 'filename' => 'toeikanembu.php', 'name' => 'toeikanembu', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Toeikan - Embú das Artes - SP<br>
Coordenação técnica: Shihan Marcos Kojika<br>
Faixa Preta 5º DAN';
}
