 ...
 */
    ...
    class seishincajamarPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Seishin Kyokushin - Cajamar');
    ...
    try
    {
        $Page = new seishincajamarPage("seishincajamar", "seishincajamar.php", GetCurrentUserPermissionsForPage("seishincajamar"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("seishincajamar"));
