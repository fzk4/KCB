...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Seishin Kyokushin - Cajamar', 'filename' => 'seishincajamar.php', 'name' => 'seishincajamar', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Seishin Kyokushin - Cajamar - SP<br>
Coordenação técnica: Shihan Reinaldo José Gomes<br>
Faixa Preta 5º DAN<br>
Coordenação técnica: Sensei Oziel<br>
Faixa Preta 3º DAN';
}
