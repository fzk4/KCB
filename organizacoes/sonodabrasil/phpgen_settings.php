...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Kyokushin Sonoda Brasil', 'filename' => 'sonodabrasil.php', 'name' => 'sonodasorocaba', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Kyokushin Sonoda Brasil <br>
Coordenação: Shihan Cesar Maximiano <br>
Faixa Preta 5º DAN';
}
