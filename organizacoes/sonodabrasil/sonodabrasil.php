 ...
 */
    ...
    class sonodasorocabaPage extends Page
    {
        ...
        {
            $this->SetTitle('Kyokushin Sonoda Brasil');
    ...
    try
    {
        $Page = new sonodasorocabaPage("sonodasorocaba", "sonodabrasil.php", GetCurrentUserPermissionsForPage("sonodasorocaba"), 'UTF-8');
