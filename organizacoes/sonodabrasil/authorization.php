...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('sonodasorocaba' => new PermissionSet(false, false, false, false))
    ,
    'budokaisp' => 
        array('sonodasorocaba' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'sonodabrasil' => new PermissionSet(true, true, true, true));

$dataSourceRecordPermissions = array();

$tableCaptions = array('sonodasorocaba' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
