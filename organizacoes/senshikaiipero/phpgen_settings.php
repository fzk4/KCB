...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Senshikai - Iperó', 'filename' => 'senshikaiipero.php', 'name' => 'senshikaiipero', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Senshikai - Iperó - SP<br>
Coordenação técnica: Sensei Alex Calixto<br>
Faixa Preta 4º DAN';
}
