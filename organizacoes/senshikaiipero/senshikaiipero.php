 ...
 */
    ...
    class senshikaiiperoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Senshikai - Iperó');
    ...
    try
    {
        $Page = new senshikaiiperoPage("senshikaiipero", "senshikaiipero.php", GetCurrentUserPermissionsForPage("senshikaiipero"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("senshikaiipero"));
