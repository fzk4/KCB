 ...
 */
    ...
    class sokyokushincaraguaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('So Kyokushin - Caraguatatuba');
    ...
    try
    {
        $Page = new sokyokushincaraguaPage("sokyokushincaragua", "sokyokushincaragua.php", GetCurrentUserPermissionsForPage("sokyokushincaragua"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sokyokushincaragua"));
