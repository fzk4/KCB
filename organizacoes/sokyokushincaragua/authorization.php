...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('sokyokushincaragua' => new PermissionSet(false, false, false, false))
    ,
    'budokaisp' => 
        array('sokyokushincaragua' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'sokyokushincaragua' => new PermissionSet(true, true, true, true),
...
$tableCaptions = array('sokyokushincaragua' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
