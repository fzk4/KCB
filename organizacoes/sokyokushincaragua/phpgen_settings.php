...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'So Kyokushin - Caraguatatuba', 'filename' => 'sokyokushincaragua.php', 'name' => 'sokyokushincaragua', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'So Kyokushin - Caraguatatuba - SP <br>
Coordenação técnica: Sensei José Ribeiro <br>
Faixa Preta 4º DAN';
}
