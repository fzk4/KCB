 ...
 */
    ...
    class heikokaiabcPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sonoda Group Brasil - ABC Paulista');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'RESP', 'RESP', 'Resonsável'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('RESP', 'RESP', 'Resonsável', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editor->SetMaxLength(30);
            $editColumn = new CustomEditColumn('Resonsável', 'RESP', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new heikokaiabcPage("heikokaiabc", "heikokaiabc.php", GetCurrentUserPermissionsForPage("heikokaiabc"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("heikokaiabc"));
