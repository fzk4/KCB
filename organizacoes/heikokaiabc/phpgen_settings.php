...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Sonoda Group Brasil - ABC Paulista', 'filename' => 'heikokaiabc.php', 'name' => 'heikokaiabc', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Sonoda Group Brasil - ABC Paulista - SP<br>
Coordenação técnica: Sensei Luis Freitas<br>
Faixa Preta 2º DAN';
}
