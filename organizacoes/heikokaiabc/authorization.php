...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('heikokaiabc' => new PermissionSet(false, false, false, false))
    ,
    'adminkcb' => 
        array('heikokaiabc' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'sonodaabc' => new PermissionSet(true, true, true, true),
    'sonodasantoandre' => new PermissionSet(false, false, false, false),
    'sonodabrasil' => new PermissionSet(false, false, false, false));

$dataSourceRecordPermissions = array();

$tableCaptions = array('heikokaiabc' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
