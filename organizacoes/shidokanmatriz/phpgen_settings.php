...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Shidokan Matriz - Santo Andre', 'filename' => 'shidokanmatriz.php', 'name' => 'shidokanmatriz', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Shidokan Matriz - Santo André - SP<br>
Coordenação técnica: Shihan Paulo Ken Misumi<br>
Faixa Preta 4º DAN';
}
