 ...
 */
    ...
    class shidokanmatrizPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Shidokan Matriz - Santo Andre');
    ...
    try
    {
        $Page = new shidokanmatrizPage("shidokanmatriz", "shidokanmatriz.php", GetCurrentUserPermissionsForPage("shidokanmatriz"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("shidokanmatriz"));
