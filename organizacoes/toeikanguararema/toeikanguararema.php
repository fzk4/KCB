 ...
 */
    ...
    class toeikanguararemaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Toeikan - Guararema');
    ...
    try
    {
        $Page = new toeikanguararemaPage("toeikanguararema", "toeikanguararema.php", GetCurrentUserPermissionsForPage("toeikanguararema"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("toeikanguararema"));
