 ...
 */
    ...
    class heikokaisantoandrePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Projeto Lutar e Vencer - Núcleo 3 - Sonoda Group Brasil - Santo André');
    ...
    try
    {
        $Page = new heikokaisantoandrePage("heikokaisantoandre", "heikokaisantoandre.php", GetCurrentUserPermissionsForPage("heikokaisantoandre"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("heikokaisantoandre"));
