...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('heikokaisantoandre' => new PermissionSet(false, false, false, false))
    ,
    'adminkcb' => 
        array('heikokaisantoandre' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'sonodasantoandre' => new PermissionSet(true, true, true, true),
    'sonodabrasil' => new PermissionSet(false, false, false, false));

$dataSourceRecordPermissions = array();

$tableCaptions = array('heikokaisantoandre' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
