...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Projeto Lutar e Vencer - Núcleo 3 - Sonoda Group Brasil - Santo André', 'filename' => 'heikokaisantoandre.php', 'name' => 'heikokaisantoandre', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Projeto Lutar e Vencer - Núcleo 3 <br>
Sonoda Group Brasil - Santo André - SP<br>
Coordenação técnica: Shihan Otávio Lunardi<br>
Faixa Preta 6º DAN';
}
