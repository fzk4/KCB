 ...
 */
    ...
    class fkcombatguaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('FK Combat - Guarulhos');
    ...
    try
    {
        $Page = new fkcombatguaPage("fkcombatgua", "fkcombatgua.php", GetCurrentUserPermissionsForPage("fkcombatgua"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("fkcombatgua"));
