...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'FK Combat - Guarulhos', 'filename' => 'fkcombatgua.php', 'name' => 'fkcombatgua', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'FK Combat - Guarulhos - SP<br>
Coordenação técnica: Sensei Fernando<br>
Faixa Preta 1º DAN';
}
