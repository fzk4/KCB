...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('sokyokushintaubate' => new PermissionSet(false, false, false, false))
    ,
    'sokyokushintaubate' => 
        array('sokyokushintaubate' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'sokyokushintaubate' => new PermissionSet(true, true, true, true),
...
$tableCaptions = array('sokyokushintaubate' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
