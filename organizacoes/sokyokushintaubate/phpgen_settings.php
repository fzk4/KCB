...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'So - Kyokushin - Taubaté', 'filename' => 'sokyokushintaubate.php', 'name' => 'sokyokushintaubate', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'So Kyokushin - Taubaté - SP <br>
Coordenação técnica: Sensei André Bacci <br>
Faixa Preta 3º DAN';
}
