 ...
 */
    ...
    class shidokanheliopolisPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Shidokan - Heliópolis');
    ...
    try
    {
        $Page = new shidokanheliopolisPage("shidokanheliopolis", "shidokanheliopolis.php", GetCurrentUserPermissionsForPage("shidokanheliopolis"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("shidokanheliopolis"));
