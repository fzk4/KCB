...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('shidokanheliopolis' => new PermissionSet(false, false, false, false))
    ,
    'shidokanheliopolis' => 
        array('shidokanheliopolis' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'shidokanheliopolis' => new PermissionSet(true, true, true, true),
...
$tableCaptions = array('shidokanheliopolis' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
