...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Shidokan - Heliópolis', 'filename' => 'shidokanheliopolis.php', 'name' => 'shidokanheliopolis', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Shidokan - Heliópolis - SP<br>
Coordenação técnica: Shihan Alexandre Prates<br>
Faixa Preta 4º DAN';
}
