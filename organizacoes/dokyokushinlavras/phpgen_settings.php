...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Do Kyokushin - Lavras', 'filename' => 'dokyokushinlavras.php', 'name' => 'dokyokushinlavras', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Do Kyokushin - Lavras - MG<br>
Coordenação técnica: Shihan José Carlos<br>
Faixa Preta 5º DAN';
}
