 ...
 */
    ...
    class dokyokushinlavrasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Do Kyokushin - Lavras');
    ...
    try
    {
        $Page = new dokyokushinlavrasPage("dokyokushinlavras", "dokyokushinlavras.php", GetCurrentUserPermissionsForPage("dokyokushinlavras"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("dokyokushinlavras"));
