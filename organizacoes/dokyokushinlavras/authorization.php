...
$grants = array('guest' => 
    ...
    ,
    'defaultUser' => 
        array('dokyokushinlavras' => new PermissionSet(false, false, false, false))
    ,
    'dokyokushinlavras' => 
        array('dokyokushinlavras' => new PermissionSet(false, false, false, false))
    ,
...
$appGrants = array('guest' => new PermissionSet(false, false, false, false),
    ...
    'dokyokushinlavras' => new PermissionSet(true, true, true, true),
...
$tableCaptions = array('dokyokushinlavras' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI');
