 ...
 */
    ...
    class budokaispPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Budokai - São Paulo');
    ...
    try
    {
        $Page = new budokaispPage("budokaisp", "budokaisp.php", GetCurrentUserPermissionsForPage("budokaisp"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("budokaisp"));
