...
{
    $result = array();
    $result[] = array('caption' => 'Inscrição de atletas em campeonatos do sistema KCB/CBKI', 'short_caption' => 'Budokai - São Paulo', 'filename' => 'budokaisp.php', 'name' => 'budokaisp', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Budokai - São Paulo - SP<br>
Coordenação técnica: Shihan Austerio Couto<br>
Faixa Preta 7º DAN';
}
