...
{
    $result = array();
    $result[] = array('caption' => 'Relação geral de cadastrados', 'short_caption' => 'Todo banco', 'filename' => 'todobanco.php', 'name' => 'todobanco', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Inscritos para KATA', 'short_caption' => 'Relação geral de inscritos para KATA', 'filename' => 'todosinscritos.php', 'name' => 'todosinscritos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Staff', 'short_caption' => 'Staff', 'filename' => 'staff.php', 'name' => 'staff', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'EXPORTAÇÃO dos inscritos', 'short_caption' => 'Exportar dados dos inscritos', 'filename' => 'listagemexportar.php', 'name' => 'todosinscritos01', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Integranteskcb', 'short_caption' => 'Integranteskcb', 'filename' => 'integranteskcb.php', 'name' => 'integranteskcb', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'Gerenciamento de Inscrições Eventos
KCB - Karate Contato Brasil';
}
