 ...
 */
    ...
    class todobancoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Todo banco');
            $this->SetMenuLabel('Relação geral de cadastrados');
    
            $selectQuery = 'SELECT * 
            FROM (SELECT * FROM budokaisp UNION ALL 
                  SELECT * FROM cobrakaisonoda UNION ALL 
                  SELECT * FROM dokyokushinlavras UNION ALL 
                  SELECT * FROM fkcombatgua UNION ALL 
                  SELECT * FROM heikokaiabc UNION ALL 
                  SELECT * FROM heikokaisantoandre UNION ALL 
                  SELECT * FROM seishincajamar UNION ALL 
                  SELECT * FROM senshikaiipero UNION ALL 
                  SELECT * FROM shidokanheliopolis UNION ALL 
                  SELECT * FROM shidokanmatriz UNION ALL 
                  SELECT * FROM sokyokushincaragua UNION ALL 
                  SELECT * FROM sokyokushintaubate UNION ALL 
                  SELECT * FROM sonodasorocaba UNION ALL 
                  SELECT * FROM toeikanmogisuzano UNION ALL 
                  SELECT * FROM toeikanembu UNION ALL 
                  SELECT * FROM toeikanguararema UNION ALL 
                  SELECT * FROM toeikansp
                 ) res';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'todobanco');
    ...
    try
    {
        $Page = new todobancoPage("todobanco", "todobanco.php", GetCurrentUserPermissionsForPage("todobanco"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("todobanco"));
