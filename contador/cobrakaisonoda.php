 ...
 */
    ...
    class cobrakaisonodaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Cobrakaisonoda');
            $this->SetMenuLabel('Cobrakaisonoda');
    ...
    try
    {
        $Page = new cobrakaisonodaPage("cobrakaisonoda", "cobrakaisonoda.php", GetCurrentUserPermissionsForPage("cobrakaisonoda"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("cobrakaisonoda"));
