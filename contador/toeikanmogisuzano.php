 ...
 */
    ...
    class toeikanmogisuzanoPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Toeikanmogisuzano');
            $this->SetMenuLabel('Toeikanmogisuzano');
    ...
    try
    {
        $Page = new toeikanmogisuzanoPage("toeikanmogisuzano", "toeikanmogisuzano.php", GetCurrentUserPermissionsForPage("toeikanmogisuzano"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("toeikanmogisuzano"));
