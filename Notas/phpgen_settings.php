...
{
    $result = array();
    $result[] = array('caption' => 'Pontuação Arbitragem', 'short_caption' => 'Pontuação Arbitragem', 'filename' => 'notaarbitragem.php', 'name' => 'notaarbitragem', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
