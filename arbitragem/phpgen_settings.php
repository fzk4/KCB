...
{
    $result = array();
    $result[] = array('caption' => 'Arbitragem e Staff', 'short_caption' => 'Arbitragem e Staff', 'filename' => 'staff.php', 'name' => 'staff', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        'KCB - Karate de Contato do Brasil<br>
Coordenação: Shihan Otávio Lunardi';
}
